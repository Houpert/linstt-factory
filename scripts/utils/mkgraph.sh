...
if [[ ! -s $lang/tmp/LG.fst || $lang/tmp/LG.fst -ot $lang/G.fst || \
  ...
  fsttablecompose $lang/L_disambig.fst $lang/G.fst > $lang/LG_temp.fst
  fstdeterminizestar --use-log=true $lang/LG_temp.fst > $lang/LG_det.fst
  rm $lang/LG_temp.fst
  fstminimizeencoded $lang/LG_det.fst > $lang/LG_min.fst
  rm $lang/LG_det.fst
  fstpushspecial $lang/LG_min.fst > $lang/LG_push.fst
  rm $lang/LG_min.fst
  fstarcsort --sort_type=ilabel $lang/LG_push.fst > $lang/tmp/LG.fst || exit 1;
  rm $lang/LG_push.fst
...
if [[ ! -s $clg || $clg -ot $lang/tmp/LG.fst ]]; then
  fstcomposecontext --context-size=$N --central-position=$P \
   ...
   --write-disambig-syms=$lang/tmp/disambig_ilabels_${N}_${P}.int \
    $lang/tmp/ilabels_${N}_${P} $lang/tmp/LG.fst > $lang/tmp/CLG_tmp.fst
    fstarcsort --sort_type=ilabel $lang/tmp/CLG_tmp.fst > $clg
  rm $lang/tmp/CLG_tmp.fst
...
if [[ ! -s $dir/HCLGa.fst || $dir/HCLGa.fst -ot $dir/Ha.fst || \
  ...
  fsttablecompose $dir/Ha.fst "$clg" > $dir/HaCLG_tmp.fst
  rm $dir/Ha.fst
  fstdeterminizestar --use-log=true $dir/HaCLG_tmp.fst > $dir/HaCLG_det.fst
  rm $dir/HaCLG_tmp.fst
  fstrmsymbols $dir/disambig_tid.int $dir/HaCLG_det.fst > $dir/HaCLG_sym.fst
  rm $dir/HaCLG_det.fst
  fstrmepslocal $dir/HaCLG_sym.fst > $dir/HaCLG_meps.fst
  rm $dir/HaCLG_sym.fst
  fstminimizeencoded $dir/HaCLG_meps.fst > $dir/HCLGa.fst || exit 1;
  rm $dir/HaCLG_meps.fst
